...
public class BottomScreenMatchStateViewController : BSMLAutomaticViewController
{
    ...
    void PostParse()
    {
        _redEnergyBar = CustomEnergyBar.ParseOntoViewController(this, new Vector3(0f, 0f), false, new Color(1f, .4549f, .4235f));
        _blueEnergyBar = CustomEnergyBar.ParseOntoViewController(this, new Vector3(0f, 0f), true, new Color(1f, .4549f, .4235f));
    }
